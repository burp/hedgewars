...
QString * cDataDir = new QString("/usr/local/share/hedgewars/");
QString * cProtoVer = new QString("60");
QString * cVersionString = new QString("1.1.0-dev");
QString * cRevisionString = new QString("GIT");
QString * cHashString = new QString("30def9d");
