...
if(APPLE)
    ...
    if(CMAKE_OSX_ARCHITECTURES)
        ...
        string(REGEX MATCH "([aA][rR][mM]64|[aA][aA][rR][cC][hH]64)" arm64_build "${CMAKE_OSX_ARCHITECTURES}")
        if(arm64_build)
    ...
    elseif(CMAKE_SIZEOF_VOID_P MATCHES "8")
        #if that variable is not set check if we are on arm64/aarch64 or x86_64
